...
#define ATK_MD0280_BL_GPIO_CLK_ENABLE() \
    do {                                \
        __HAL_RCC_GPIOC_CLK_ENABLE();   \
    } while (0)

/* IO操作 */
#define ATK_MD0280_BL(x)                                                                                                                                                           \
    do {                                                                                                                                                                           \
        x ? HAL_GPIO_WritePin(ATK_MD0280_BL_GPIO_PORT, ATK_MD0280_BL_GPIO_PIN, GPIO_PIN_SET) : HAL_GPIO_WritePin(ATK_MD0280_BL_GPIO_PORT, ATK_MD0280_BL_GPIO_PIN, GPIO_PIN_RESET); \
    } while (0)
